  ...
  return (
    <View style={{ flex: 1 }}>
      <View style={styles.header}>
        <View style={{ flexDirection: 'row', marginTop: 80, marginLeft: 0, marginBottom: 40 }}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('CartScreen')}>
            <Image
              ...
              style={{ width: 25, height: 26, marginLeft: 150, marginTop: 3 }}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('ChatScreen')}>
            <Image
              source={require('../assets/icon_chat.png')}
              style={{ width: 25, height: 26, marginLeft: 20, marginTop: 3 }}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate('UserScreen')}>
            <Image
              source={require('../assets/iconuser.png')}
              style={{ width: 45, height: 30, marginLeft: 10, marginTop: 3 }}
            />
          </TouchableOpacity>
        </View>
            ...
            <Pressable style={styles.search} onPress={onSearchPress}>
              ...
              <TouchableOpacity onPress={onSearchPress} hitSlop={12}>
                <Image
                  ...
                  style={{ width: 24, height: 22, marginLeft: 18, marginRight: 12, tintColor: '#E5ECFF' }}
                />
              </TouchableOpacity>
