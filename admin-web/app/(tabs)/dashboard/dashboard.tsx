...
function buildStats(orders: Order[]): DashboardStats {
  ...
  for (const o of orders) {
    ...
    totalOrders += 1;
    // Chỉ tính doanh thu và số lượng đơn đã duyệt cho tổng doanh thu và biểu đồ
    if (o.status === "approved - unpaid" || o.status === "approved - paid" || o.status === "on delivery" || o.status === "completed") {
      completedOrders += 1;
      totalRevenue += total;
        ...
        <>
          ...
          <View style={styles.cardsRow}>
            <View style={[styles.summaryCardSmall, styles.shadowCard]}>
              ...
              <Text style={styles.summaryChipSmall}>Pending</Text>
            </View>
            ...
            <View style={[styles.summaryCardSmall, styles.shadowCard]}>
              ...
              <Text style={styles.summaryChipSmall}>Canceled</Text>
            </View>
          ...
          <Text style={[styles.subtitle, { color: themeColors.text }]}>
            ...
            completed và đơn đã thanh toán).
          </Text>
